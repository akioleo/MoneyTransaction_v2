    ...
    <div class="container">
        <main class="row justify-content-center">
            <div class="col-md-7 col-lg-12">
                <h4 class="mb-3">Por favor confirme os dados para realizar o depósito</h4>
                <form class="needs-validation" method="post" >
                    <div class="row g-3">
                        <div class="col-sm-12">
                            <label for="firstName" class="form-label">Nome Completo</label>
                            <input type="text" name="name" class="form-control" id="firstName" placeholder="Digite seu nome completo" value="" required>
