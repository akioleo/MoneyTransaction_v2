...
<head>
    ...
    <link rel="stylesheet" href="{{ url(mix('extras/css/style.css')) }}">
</head>
<body>
    ...
    <header>
        <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
            <a href="/" class="d-flex align-items-center text-dark text-decoration-none">
                <svg xmlns="http://www.w3.org/2000/svg" width="45" height="38" fill="currentColor" class="bi bi-cash-coin" viewBox="0 0 16 16">
                ...
                <span class="fs-4">MoneyTransaction</span>
            </a>
            ...
            <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
                @if (Route::has('login'))
                    <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                        ...
                        @else
                            <a href="{{ route('home') }}" class="me-3 py-2 text-dark text-decoration-none">Home</a>
                            @if (Route::is('login'))
